<template>
  <div class="play">
    ...
    ></audio>
    <div class="img-div">
      <img :class="{'play-img': isPlaying}" src="../../static/img/needle-ip6.png" width="100px" alt="">
    </div>
    <div class="cd">
      <img
        v-if="detail['al']"
    ...
    methods: {
      ...
      getLyric(id) {
        this.$http("lyric", { params: { id } })
          .then((res) => {
            /**@namespace res.data.lrc.lyric**/
            this.finalLrc = this.transLrc(res.data.lrc.lyric);
          })
          .catch((err) => {
            console.log(err);
          });
      ...
      getDetail(id) {
        this.$http("/song/detail", { params: { ids: id } })
          .then((res) => {
            /**@namespace res.data.songs**/
